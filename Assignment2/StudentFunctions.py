import sqlite3
from Student import StudentAttributes
...
#Creates a student
    ...
    def createStudent(self):
        ...
        Student = StudentAttributes(FirstName, LastName, GPA, typeMajor, nameAdviser)

        cursor.execute("INSERT INTO Student (FirstName, LastName, GPA, Major, FacultyAdviser)"
                    "VALUES (?, ?, ?, ?, ?)", (Student.FirstName, Student.LastName, Student.GPA, Student.typeMajor, Student.nameAdviser))
